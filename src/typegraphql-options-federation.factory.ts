...
import { buildSchema, ClassType, createResolversMap, NonEmptyArray } from 'type-graphql';
...
import { TypeGraphQLRootFederationModuleOptions, TypeGraphQLFeatureFederationModuleOptions } from './types';
...
export default class TypeGraphQLFederationOptionsFactory implements GqlOptionsFactory {
  ...
  async createGqlOptions(): Promise<Omit<GqlModuleOptions, 'driver'>> {
    ...
    const { resolversClasses, container, orphanedTypes, featureModuleOptionsArray } =
